...
def gen_input(element_in,kx,ky,kz,structure_path,magmom,magmom_string,mode):
    ...
    if mode == 'non_metal':
        ...
        keywords_non_metal_cont['write_denskern'] = False
        keywords_non_metal_cont['write_tightbox_ngwfs'] = False
        ...
        keywords_nobel_gas_cont['write_denskern'] = False
        keywords_nobel_gas_cont['write_tightbox_ngwfs'] = False
        ...
        keywords_metal_cont['write_denskern'] = False
        keywords_metal_cont['write_tightbox_ngwfs'] = False
        ...
        keywords_metal_mag_cont['write_denskern'] = False
        keywords_metal_mag_cont['write_tightbox_ngwfs'] = False
...
#---------------------------------
# Magnetic systems configurations
#---------------------------------
#  8 O conf=2s2.0 2p4.0 INIT SPIN= CHARGE=0
#  24 Cr conf=3s2 3p6 3d5 4s1 4p0 INIT SPIN=
#  25 Mn conf=3s2 3p6 3d5 4s2 4p0 INIT SPIN=
#
#  26 Fe conf=3s2 3p6 3d5 4s0 4p0 INIT SPIN=
#  27 Co conf=3s2.0 3p6 3d7 4s2 4p0 INIT SPIN=
#  28 Ni conf=3s2.0 3p6 3d8 4s2 4p0 INIT SPIN=
